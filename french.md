...
Il existe sur cette plate-forme trois autres référentiels qui sont reliés à ce référentiel. Dans la [communauté](https://github.com/ehealthsuisse/Community/blob/main/README.md), on trouve des [discussions](https://github.com/ehealthsuisse/Community/discussions) divisées par thèmes ainsi que la nétiquette de cette plate-forme. Sous official [Announcements]() sont annoncées les nouvelles concernant Snomed CT. Sous [Archives]() sont archivées les réponses aux questions, les contributions aux discussions et les informations.
